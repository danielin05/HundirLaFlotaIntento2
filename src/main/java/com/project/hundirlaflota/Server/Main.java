...
import com.project.hundirlaflota.Client.CtrlPagePrincipal;
...
public class Main extends WebSocketServer {
    ...
    private static final List<String> PLAYER_NAMES = Arrays.asList("Z", "B");
    ...
    public static String askSystemName() {
        ...
        try {
            ...
            if (osName.contains("win")) {
                // En Windows, podrías usar el comando "ver" para obtener información básica del sistema
                processBuilder = new ProcessBuilder("cmd.exe", "/c", "ver");
            } else {
                // En sistemas Unix/Linux, usa "uname -r"
